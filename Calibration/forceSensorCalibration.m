...
load 1.5_test/test.txt
load 1.5_test/test_zeroed.txt;
...
R_aug = R2(ForceData,testCal_aug);
R0_aug = R2(ForceData0,testCal0_aug);
...
fprintf('R^2 of the calibration results (augmented): %.4f.\n', R_aug);
fprintf('\n');
...
fprintf('R^2 of the zeroed calibration results (augmented): %.4f.\n', R0_aug);
